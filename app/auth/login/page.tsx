    ...
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="hidden lg:flex flex-col w-1/2 bg-blue-600 text-white p-10 justify-between">
        <div>
          ...
          <p className="text-xl text-blue-100 mb-8">Log in to access your notes, documents, and ideas.</p>
        </div>
      ...
      <div className="flex flex-col items-center justify-center w-full lg:w-1/2 p-8">
        <div className="w-full max-w-md">
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-center">Enter your email below to access your notes</p>
          </div>
